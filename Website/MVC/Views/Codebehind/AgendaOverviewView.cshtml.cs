...
{
    public class AgendaOverviewView : AbstractRazorControl<AgendaOverviewModel>
    {
        private ISitecoreContext _context;

        public override AgendaOverviewModel GetModel()
        {
            _context = new SitecoreContext();
            return _context.GetCurrentItem<AgendaOverviewModel>();
        }
    }
}